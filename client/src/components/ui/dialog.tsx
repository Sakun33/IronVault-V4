...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] z-50 flex flex-col w-full max-w-[calc(100vw-32px)] translate-x-[-50%] border border-border/50 bg-background shadow-xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=open]:slide-in-from-left-1/2 rounded-2xl overflow-hidden top-4 translate-y-0 max-h-[calc(100dvh-32px)] sm:top-[50%] sm:-translate-y-1/2 sm:max-h-[85dvh] sm:max-w-lg",
        className
      )}
      {...props}
    >
