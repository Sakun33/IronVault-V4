// IronVault PWA Service Worker v3.49.0
//
// Strategy:
...
const CACHE_VERSION = 'ironvault-v3.49.0';
const ASSETS_CACHE  = 'ironvault-assets-v3.49.0';
const DYNAMIC_CACHE = 'ironvault-dynamic-v3.49.0';
