// IronVault PWA Service Worker v3.9.9
//
// Strategy:
...
const CACHE_VERSION = 'ironvault-v3.9.9';
const ASSETS_CACHE  = 'ironvault-assets-v3.9.9';
const DYNAMIC_CACHE = 'ironvault-dynamic-v3.9.9';
